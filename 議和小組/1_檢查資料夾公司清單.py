...
# === 路徑設定（請確認） ===
STEW_BASE = Path("data/議和小組盡職治理報告書/Report_chunks")
ESG_BASE  = Path("data/議和小組永續報告書/Report/Report_chunks")

# 輸出檔名（可改）
OUTPUT_XLSX = Path("議和小組/Report_pairs_index_1015.xlsx")
OUTPUT_CSV  = Path("議和小組/Report_pairs_index_1015.csv")
