...
# ======== 基本路徑 ========
STEW_CHUNK_BASE_DIR = Path(r"C:\Users\bugee\OneDrive\桌面\Automated-model-to-assess-TCFD-reports\data\議和小組盡職治理報告書\Report_chunks")
ESG_CHUNK_BASE_DIR  = Path(r"C:\Users\bugee\OneDrive\桌面\Automated-model-to-assess-TCFD-reports\data\議和小組永續報告書\Report\Report_chunks")

DEFINITION_CSV      = Path(r"./SES_engagement_level.csv")
ENV_PATH            = Path(r"C:\Users\bugee\OneDrive\桌面\Automated-model-to-assess-TCFD-reports\.env")
PAIRS_LIST_PATH     = Path(r"./filed_list_pairs_lines.txt")
# 逐 chunk 稽核輸出（前 5 家）
OUTPUT_CHUNK_CSV    = Path(r"./output/ESGreport_SE_level_output_chunk_scores_FULL.csv")
OUTPUT_FINAL_CSV    = Path(r"./output/ESGreport_SE_level_output_averaged_weighted_FULL.csv")
